        ...
        <div className="flex h-16 items-center justify-between">
          ...
          <div className="flex items-center">
            <button
              ...
              className="px-3 py-1 text-sm font-medium text-red-500 border border-red-500 rounded hover:bg-red-600 hover:text-white transition"
            >
              Log-Out
            </button>
            <button
              ...
              className="ml-2 sm:hidden p-2 rounded-md text-gray-400 hover:bg-gray-700 hover:text-white"
            >
